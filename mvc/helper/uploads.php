...
class uploads {
    function upload($files, $path_dir, $name, $width = 300, $height = 300){
        ...
        // Tạo tên ảnh gốc và ảnh thu nhỏ, đảm bảo ảnh gốc và thu nhỏ có tên khác nhau
        $nameImage = $path_dir . $name . '-' . $this->createName() . '-original.' . $ext;
        $nameImageThumb = $path_dir_thumb . $name . '-' . $this->createName() . '-thumb.' . $ext;
