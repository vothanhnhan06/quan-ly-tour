        ...
        <article>
            ...
            <div class="main-container">
                                ...
                                <div class="col-12 col-md-4">
                                    <div class="input-wrapper ">
                                        ...
                                        <input type="text" name="destination" id="destination" required
                                            placeholder="Nhập điểm đến" class="input-field form-control">
                                    </div>
                                </div>
                        ...
                        <div class="responsive">
                            <div class="gallery">
                                ...
                                <div class="desc">
                                    ...
                                    <a target="_blank" href="product/detail/<?=$value['slug']?>">
                ...
                <section class="tourdacbiet">
                    ...
                    <?php }?>
                    <div class="see-more">
                        <a href="link_to_detail_page_2.html" id="xemthem">Xem thêm</a>
                    </div>
                </section>
                <!--Các đánh giá -->
